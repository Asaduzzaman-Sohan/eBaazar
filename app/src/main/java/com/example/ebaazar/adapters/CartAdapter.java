...
import com.example.ebaazar.databinding.ItemCartBinding;
import com.example.ebaazar.databinding.QuantityDialogBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.binding.price.setText(product.getPrice() + " BDT");
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantityDialogBinding.btnAdd.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                ...
                quantityDialogBinding.btnSub.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        int quantity = product.getQuantity();
                        if (quantity > 1)
